...
export const renderAbout = (): HTMLElement => {
  ...
  const contentGrid = createElement('div', { className: 'about-grid glass-card reveal' });
  
  const textCol = createElement('div', { className: 'about-text' });
  textCol.innerHTML = `
  ...
  const photoCol = createElement('div', { className: 'about-photo-wrapper' });
