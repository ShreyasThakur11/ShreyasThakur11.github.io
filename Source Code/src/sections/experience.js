  ...
  const experiences = [
    {
      ...
      certTitle: 'Experience Letter - Santosh S. Bakshetti'
    },
    {
      ...
      certTitle: 'Internship Certificate - Epigral Ltd.'
    }
  ];
    ...
    if (exp.certificate) {
      certHtml = `
        <div class="exp-actions">
          <button class="btn btn-ghost text-sm view-cert-btn" data-url="${exp.certificate}" data-title="${exp.certTitle}">
